            ...
            for (let i in all_categories) {
                ...
                if (category.parent_id === 'None') {
                    if (category.children.length !== 0) {
                        ...
                        //   </ul>
                        // </div>`)
                        $('#for_category').append(`<li><a href="#"><span class="add-category fa fa-plus" style="font-size: 16px"></span id=${span_id}>${category.category_name}</a><ul id=${cat_id}></ul></li>`)
                    } else {
                        ...
                        //
                        // </li>`)
                        $("#for_category").append(`<li><a href="#"><span class="add-category fa fa-plus" style="font-size: 16px"></span id=${span_id}>${category.category_name}</a></li>`)
                    }
...
//       </li>
// `)
                        $(par_id).append(`<li><a href="#"><span class="add-category fa fa-plus" style="font-size: 16px"></span id=${span_id}>${category.category_name}</a><ul id="${cat_id}"></ul></li>`)
                    } else {
                        let par_id = '#id_' + category.parent_id
                        let span_id = 'id' + category._id
                        ...
                        // }
                        $(par_id).append(`<li><a href="#"><span class="add-category fa fa-plus" style="font-size: 16px"></span id=${span_id}>${category.category_name}</a></li>`)
